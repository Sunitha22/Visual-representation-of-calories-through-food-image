...
data = pd.read_csv(r"C:\Users\Naveen_The_Roy\Desktop\Food_Recognition_System-WebApp\Healthy_Diet_Data.csv")
...
def protein_diet(grains, vegetables, fruits, protein):
    ...
    if( protein_diet >= 20):
        print('Protein Healthy')
        return 'Following a Protein Healthy '
    else:
        print('Protein Healthy')
        return 'Not Following a Healthy Protein Diet, Include Lean Meats, Fish and Seafood, Eggs, Milk, Yoghurt, Nuts, Beans in your Diet'



def grains_diet(grains, vegetables, fruits, protein):
    ...
    if(grains_diet >= 25):
        print('grains Healthy')
        return 'Following a Grains Healthy '
    else:
        print('grains Healthy')
        return 'Not Following a Healthy grains Diet, Include Whole Oats, Whole Wheat, Millet, Barley, Brown Rice in your'


def vegetables_diet(grains, vegetables, fruits, protein):
    ...
    if(vegetables_diet >= 25):
        print('grains Healthy')
        return 'Following a Vegetables Healthy '
    else:
        print('grains Healthy')
        return 'Not Following a Vegetables Healthy Diet, Include Whole Oats, Whole Wheat, Millet, Barley, Brown Rice, Sweet Potatoes in your '
